...
# Cara mendapatkan ID:
# 1. Buka MagangHub.
# 2. Pilih filter Kota Pekanbaru.
# 3. Terapkan filter.
# 4. Salin nilai city_id[0][id] dari URL.
#
# Contoh bagian URL:
# city_id%5B0%5D%5Bid%5D=UUID_KOTA_Pekanbaru
...
def validate_configuration() -> None:
    ...
    invalid_city_ids = {
        "",
        "MASUKKAN_ID_KOTA_Pekanbaru",
        "MASUKKAN_ID_KOTA_Pekanbaru_DI_SINI",
    }

    if CITY_ID.strip() in invalid_city_ids:
        raise ValueError(
            "CITY_ID Kota Pekanbaru belum diisi.\n\n"
            "Buka MagangHub, pilih filter Kota Pekanbaru, lalu salin "
